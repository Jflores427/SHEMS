        ...
        <div className="card-body text-uppercase">
          <div className="row">
            <div className="col-md-6 col-xl-12">
              ...
              >
                ...
                <select id="service-id-filter" style={{ margin: "0px 10px" }}>
                ...
                <select id="device-name-filter" style={{ margin: "0px 10px" }}>
          ...
          <div className="row">
            <div className="col-md-6 align-self-center">
              ...
              >
                Showing 1 to{" "}
                {enrolledDeviceEvents.length < 10
                  ? enrolledDeviceEvents.length
                  : "10"}{" "}
                of {enrolledDeviceEvents.length}
              </p>
            </div>
